        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
            <thead>
                <tr>
                    ...
                    <td style="width:80px;">Mã quyền</td>
                    <td>Tên quyền</td>
                    <td>Ghi chú</td>
            ...
            <tbody>
                <?php foreach ($list as $row): ?>
                    <tr>
                        <td><input type="checkbox" name="id[]" value="<?php echo $row->MaQuyen ?>" /></td>
                        <td class="textC"><?php echo $row->MaQuyen; ?></td>
                        <td>
                            <span title="<?php echo $row->TenQuyen ?>" class="tipS">
                                <?php echo $row->TenQuyen ?>					
                            </span>
                        </td>


                        <td><span title="<?php echo $row->GhiChu ?>" class="tipS">
                                <?php echo $row->GhiChu ?>					
                            </span>
                        </td>
