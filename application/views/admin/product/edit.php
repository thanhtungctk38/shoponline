<div class="wrapper">
    ...
    <!-- Form -->
    <form class="form" id="form" action="admin/product/edit/<?php echo $info->ProductID?>" method="post" enctype="multipart/form-data">
        <fieldset>
            <div class="widget">
                <div class="title">
                ...
                <div class="tab_container">
                    <div id='tab1' class="tab_content pd0">
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                    <input name="name" id="param_name" _autocheck="true" type="text" value="<?php echo $info->ProductName; ?>"/>
                                </span>
                                        ...
                                        if (count($row->subs) > 1):
                                            ...
                                            <optgroup label="<?php echo $row->CategoryName ?>">
                                                <?php foreach ($row->subs as $sub): ?>
                                                    <option value="<?php echo $sub->CategoryID ?>" <?php echo ($info->CategoryID == $sub->CategoryID) ? 'selected' : '' ?>>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <br>
                                <img src="<?php echo product_img_url($info->Image);?>">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneFour">
                                    <input style="width:100px" class="maskPct" value="<?php echo $info->Discount; ?>" type="text" name="discount"> %   
                                </span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <input style="width:100px" type="number" id="" value="<?php echo $info->Quantity; ?>" min="0" name="quantity" />
