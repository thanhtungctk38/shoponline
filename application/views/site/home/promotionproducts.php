...
<div class="container">
    ...
    <div class="illustration-v2" style="margin-bottom: 60px">
        ...
        <ul class="list-inline owl-slider">
            <?php foreach ($listPromotionProducts as $product):
            ...
            <li class="item">
                <div class="product-img">
                    ...
                    <a class="product-review" href="<?php echo "index.php?c=cart&a=add"?>"><i class="fa fa-shopping-cart"></i>Thêm vào giỏ hàng</a>
                </div>
                <div class="product-description product-description-brd">
                    <div class="overflow-h margin-bottom-5">
                        <div class="pull-left">
                            <h4 class="title-price"><a href="<?php echo $productLink?>"><?php echo $product->ProductName;?></a></h4>
